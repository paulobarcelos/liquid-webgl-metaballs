...
function (
	...
	var App = function(){
		...
		self.setup = function(){
			...
			liquid.setColors({r: 1, g:0.5, b:0}, {r: 1, g:1.0, b:0}, 0);
		}
		...
		self.onKeyUp = function(e){
			...
			switch(key){
				...
				case "W":
					...
					break
				case "T":
					socket.send({ event:"text", value: {heading:"protothon", body:"This awesome #LiquidData silk scarf goes pretty well with the leggings...See them in action this weekend at Atelier!", time_displayed: 60 } });
					break
				case "A":
